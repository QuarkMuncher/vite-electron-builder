...
[![GitHub issues by-label](https://img.shields.io/github/issues/QuarkMuncher/vite-electron-builder/help%20wanted?label=issues%20need%20help&logo=github)](https://github.com/QuarkMuncher/vite-electron-builder/issues?q=label%3A%22help+wanted%22+is%3Aopen+is%3Aissue)
...
___
### Support
- This template is forked from [Alex Kozacks][cawa-93-github] repo. You can [💖 sponsor him][cawa-93-sponsor] for continued development of that template.

- I will probably not actively work on this.

- Found a problem? Pull requests are welcome.

- Can't fix the issue yourself? Open an issue
